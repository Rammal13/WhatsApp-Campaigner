          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-2xl border-2 border-green-500 shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-2xl font-bold text-black">Reseller Details</h3>
                <button
                  onClick={() => {
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-xl">
                  <div>
                    ...
                    <p className="text-black font-semibold break-all">{selectedReseller.id}</p>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-600">Company Name:</span>
                    <p className="text-black font-semibold">{selectedReseller.companyName}</p>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-600">Email:</span>
                    <p className="text-black font-semibold">{selectedReseller.email}</p>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-600">Phone Number:</span>
                    <p className="text-black font-semibold">{selectedReseller.number}</p>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-600">Role:</span>
                    <p className="text-black font-semibold uppercase">{selectedReseller.role}</p>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-600">Balance:</span>
                    <p className="text-green-600 font-bold text-xl">₹{selectedReseller.balance}</p>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-600">Total Resellers:</span>
                    <p className="text-black font-semibold">{selectedReseller.resellerCount}</p>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-600">Total Users:</span>
                    <p className="text-black font-semibold">{selectedReseller.userCount}</p>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-600">Total Campaigns:</span>
                    <p className="text-black font-semibold">{selectedReseller.totalCampaigns}</p>
                  </div>
                  <div>
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="text-black font-semibold">{formatDate(selectedReseller.createdAt)}</p>
                  </div>
                </div>
              </div>
            </div>
