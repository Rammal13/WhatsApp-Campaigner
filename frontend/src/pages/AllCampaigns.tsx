  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 bg-white/40 backdrop-blur-lg rounded-2xl border border-white/60 shadow-xl">
        <h2 className="text-3xl font-bold text-black">All Campaigns</h2>
        <p className="text-sm text-gray-600 mt-1">View latest 50 campaigns from all users</p>
      </div>
                ...
                <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl border-2 border-blue-400 shadow-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-black font-bold text-lg mt-1">{selectedCampaign.userData.companyName}</p>
                    </div>
                    <div>
                      <span className="text-xs font-bold text-blue-700 uppercase">Email</span>
                      <p className="text-black font-semibold break-all mt-1">{selectedCampaign.userData.email}</p>
                    </div>
                    <div>
                      <span className="text-xs font-bold text-blue-700 uppercase">Phone</span>
                      <p className="text-black font-semibold mt-1">{selectedCampaign.userData.number}</p>
                    </div>
                    <div>
                      <span className="text-xs font-bold text-blue-700 uppercase">Role</span>
                      <p className="text-black font-semibold uppercase mt-1">{selectedCampaign.userData.role}</p>
                    </div>
                    <div>
                      <span className="text-xs font-bold text-blue-700 uppercase">Status</span>
                      <p className="mt-1">
                        <span className={`px-3 py-1 text-white text-xs font-bold rounded-full ${getStatusBadge(selectedCampaign.userData.status)}`}>
                    ...
                    <div>
                      ...
                      <p className="text-black font-semibold text-sm mt-1">{formatDate(selectedCampaign.userData.createdAt)}</p>
                    </div>
                  </div>
                </div>
