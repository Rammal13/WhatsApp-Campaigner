...
const Documentation = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-green-500 via-blue-500 to-purple-500 text-white py-20 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="inline-block mb-4 px-4 py-2 bg-white/20 backdrop-blur-md rounded-full text-sm font-bold">
                    ...
                    <button
                        ...
                        className="px-8 py-4 bg-white text-green-600 font-bold text-lg rounded-xl shadow-xl hover:bg-gray-100 transition-all transform hover:scale-105"
                    >
                        Get Started →
                    </button>
                </div>
            ...
            <div className="flex flex-col lg:flex-row max-w-7xl mx-auto px-4 py-8 gap-8">
                ...
                <aside className="lg:w-64 lg:sticky lg:top-8 lg:self-start">
                    ...
                    <button
                        ...
                        className="lg:hidden w-full mb-4 p-4 bg-white/60 backdrop-blur-lg rounded-xl border border-white/80 shadow-lg flex items-center justify-between font-bold text-black"
                    >
                    ...
                    <nav
                        className={`${isMobileMenuOpen ? 'block' : 'hidden'
                            } lg:block bg-white/60 backdrop-blur-lg rounded-2xl border border-white/80 shadow-xl p-4 space-y-2`}
                    >
                        {navItems.map((item) => {
                ...
                <main className="flex-1 space-y-12">
                    ...
                    <section id="getting-started" className="scroll-mt-8">
                        <div className="bg-white/60 backdrop-blur-lg rounded-2xl border border-white/80 shadow-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-3xl font-bold text-black">Getting Started</h2>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-black mb-3 flex items-center gap-2">
                                        ...
                                        What is WhatsApp Campaign Manager?
                                    </h3>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="bg-white rounded-lg p-4 border-2 border-gray-200">
                                            <p className="font-bold text-gray-800 mb-1">💻 Device</p>
                                            <p className="text-sm text-gray-600">Desktop, Tablet, or Mobile</p>
                                        </div>
                                        <div className="bg-white rounded-lg p-4 border-2 border-gray-200">
                                            <p className="font-bold text-gray-800 mb-1">🌐 Browser</p>
                                            <p className="text-sm text-gray-600">Chrome, Firefox, Safari, Edge</p>
                                        </div>
                                        <div className="bg-white rounded-lg p-4 border-2 border-gray-200">
                                            <p className="font-bold text-gray-800 mb-1">📶 Internet</p>
                                            <p className="text-sm text-gray-600">Stable connection required</p>
                                        </div>
                                        <div className="bg-white rounded-lg p-4 border-2 border-gray-200">
                                            <p className="font-bold text-gray-800 mb-1">👤 Account</p>
                                            <p className="text-sm text-gray-600">User registration needed</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ol className="space-y-3">
                                        <li className="flex gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">Register with your company name, email, and phone number</p>
                                            </div>
                                        </li>
                                        <li className="flex gap-3">
                                            ...
                                            <div>
                                                <p className="font-bold text-gray-800">Login to Dashboard</p>
                                                <p className="text-sm text-gray-600">Access your personalized campaign management dashboard</p>
                                            </div>
                                        </li>
                                        <li className="flex gap-3">
                                            ...
                                            <div>
                                                <p className="font-bold text-gray-800">Create Your First Campaign</p>
                                                <p className="text-sm text-gray-600">Navigate to "Send WhatsApp" and start creating!</p>
                                            </div>
                                        </li>
                                    </ol>
                                </div>
                    ...
                    <section id="features" className="scroll-mt-8">
                        <div className="bg-white/60 backdrop-blur-lg rounded-2xl border border-white/80 shadow-xl p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {/* Campaign Management */}
                                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-300 shadow-md hover:scale-105 transition-transform">
                                    <div className="flex items-center gap-3 mb-3">
                                        <MessageSquare className="w-8 h-8 text-green-600" />
                                        <h3 className="text-xl font-bold text-green-800">Campaign Management</h3>
                                    </div>
                                ...
                                {/* Bulk Messaging */}
                                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-300 shadow-md hover:scale-105 transition-transform">
                                    <div className="flex items-center gap-3 mb-3">
                                        <Send className="w-8 h-8 text-blue-600" />
                                        <h3 className="text-xl font-bold text-blue-800">Bulk WhatsApp Messaging</h3>
                                    </div>
                                    <p className="text-gray-700">
                                ...
                                {/* Excel Export */}
                                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border-2 border-purple-300 shadow-md hover:scale-105 transition-transform">
                                    <div className="flex items-center gap-3 mb-3">
                                        <Download className="w-8 h-8 text-purple-600" />
                                        <h3 className="text-xl font-bold text-purple-800">Excel Export</h3>
                                    </div>
                                    <p className="text-gray-700">
                                ...
                                {/* Date Filtering */}
                                <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 border-2 border-orange-300 shadow-md hover:scale-105 transition-transform">
                                    <div className="flex items-center gap-3 mb-3">
                                        <Calendar className="w-8 h-8 text-orange-600" />
                                        <h3 className="text-xl font-bold text-orange-800">Advanced Filtering</h3>
                                    </div>
                                    <p className="text-gray-700">
                                ...
                                {/* Admin Dashboard */}
                                <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border-2 border-red-300 shadow-md hover:scale-105 transition-transform">
                                    <div className="flex items-center gap-3 mb-3">
                                        <Shield className="w-8 h-8 text-red-600" />
                                        <h3 className="text-xl font-bold text-red-800">Admin Controls</h3>
                                    </div>
                                    <p className="text-gray-700">
                                ...
                                {/* Analytics */}
                                <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-6 border-2 border-teal-300 shadow-md hover:scale-105 transition-transform">
                                    <div className="flex items-center gap-3 mb-3">
                                        <BarChart3 className="w-8 h-8 text-teal-600" />
                                        <h3 className="text-xl font-bold text-teal-800">Campaign Analytics</h3>
                                    </div>
                                    <p className="text-gray-700">
                                ...
                                {/* Media Upload */}
                                <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6 border-2 border-pink-300 shadow-md hover:scale-105 transition-transform">
                                    <div className="flex items-center gap-3 mb-3">
                                        <Image className="w-8 h-8 text-pink-600" />
                                        <h3 className="text-xl font-bold text-pink-800">Media Support</h3>
                                    </div>
                                    <p className="text-gray-700">
                                ...
                                {/* Complaint System */}
                                <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border-2 border-yellow-300 shadow-md hover:scale-105 transition-transform">
                                    <div className="flex items-center gap-3 mb-3">
                                        <FileText className="w-8 h-8 text-yellow-600" />
                                        <h3 className="text-xl font-bold text-yellow-800">Support Tickets</h3>
                                    </div>
                                    <p className="text-gray-700">
                    ...
                    <section id="how-to-use" className="scroll-mt-8">
                        <div className="bg-white/60 backdrop-blur-lg rounded-2xl border border-white/80 shadow-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-3xl font-bold text-black">How to Use</h2>
                            </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 border-l-4 border-green-500">
                                    ...
                                    <ol className="space-y-2 text-gray-700 ml-8 list-decimal">
                                ...
                                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border-l-4 border-purple-500">
                                    <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                                        ...
                                        2. Upload Campaign Media (Optional)
                                    </h3>
                                    <ol className="space-y-2 text-gray-700 ml-8 list-decimal">
                                ...
                                {/* Download Excel */}
                                <div className="bg-gradient-to-r from-teal-50 to-green-50 rounded-xl p-6 border-l-4 border-teal-500">
                                    <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                                        <Download className="w-6 h-6 text-teal-600" />
                                        6. Download Campaign Data
                                    </h3>
                                    <ol className="space-y-2 text-gray-700 ml-8 list-decimal">
                                        ...
                                        <li>File name format: <code className="bg-gray-200 px-2 py-1 rounded text-sm">CampaignName_YYYY-MM-DD.xlsx</code></li>
                        ...
                        <div className="bg-white/60 backdrop-blur-lg rounded-2xl border border-white/80 shadow-xl p-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-sm">
                                    ...
                                    <p className="text-gray-700">
                                        <strong>A:</strong> Use the built-in Complaint System to submit issues. Admins will respond to your queries with updates and solutions. You can also reach out via email at <a href="mailto:anuppradhan929@gmail.com" className="text-blue-600 font-bold underline">anuppradhan929@gmail.com</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="about" className="scroll-mt-8">
                        <div className="space-y-8">
                            ...
                            <div className="bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 rounded-2xl border-2 border-blue-300 shadow-xl p-8">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="p-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl">
                                        <Sparkles className="w-6 h-6 text-white" />
                                    </div>
                                    <h2 className="text-3xl font-bold text-black">Project Creator</h2>
                                </div>

                                <div className="bg-white/80 backdrop-blur-lg rounded-xl p-8 space-y-6">
                                    {/* Company Info */}
                                    <div className="text-center">
                                        <div className="w-24 h-24 rounded-full mx-auto mb-4 shadow-xl overflow-hidden">
                                        <img 
                                        ...
                                        <h3 className="text-2xl font-bold text-gray-800 mb-2">ProMinds Digital</h3>
                                        <p className="text-lg text-blue-600 font-semibold mb-1">(Formerly Prolific IDEAS)</p>
                                        <p className="text-gray-600 mb-4">Digital Marketing & IT Solutions Company</p>
                                    ...
                                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 border-2 border-blue-200">
                                        <h4 className="text-lg font-bold text-gray-800 mb-3 text-center">🎯 Core Services</h4>
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                            {['Digital Marketing', 'WhatsApp Marketing', 'SEO Services', 'Web Development', 'App Development', 'Performance Marketing'].map((service) => (
                                                <div key={service} className="px-4 py-2 bg-white rounded-lg text-center text-sm font-bold text-gray-700 shadow-sm border border-blue-100">
                                                    {service}
                                                </div>
                                            ))}
                                        </div>
                                    ...
                                    <div className="space-y-3">
                                        <h4 className="text-lg font-bold text-gray-800 text-center mb-4">🌐 Connect with ProMinds Digital</h4>

                                        <a
                                            href="https://prominds.digital/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center gap-3 p-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-xl hover:from-blue-600 hover:to-purple-600 transition-all transform hover:scale-105 shadow-lg"
                                        >
                                            <Globe className="w-6 h-6" />
                                            <div className="flex-1">
                                                <p className="font-bold">ProMinds Digital Website</p>
                                                <p className="text-sm text-blue-100">prominds.digital</p>
                                            </div>
                                        </a>
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center gap-3 p-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all transform hover:scale-105 shadow-lg"
                                        >
                                            <Globe className="w-6 h-6" />
                                            <div className="flex-1">
                                                <p className="font-bold">Prolific IDEAS (Legacy Site)</p>
                                                <p className="text-sm text-purple-100">prolificideas.in</p>
                                            </div>
                                        </a>
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center gap-3 p-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all transform hover:scale-105 shadow-lg"
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm text-blue-100">Follow for updates</p>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-6">
                                        <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border-2 border-blue-300">
                                            ...
                                            <p className="text-xl font-bold text-blue-700">WhatsApp</p>
                                        ...
                                        <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border-2 border-purple-300">
                                            ...
                                            <p className="text-xl font-bold text-purple-700">SEO</p>
                                            <p className="text-xs text-gray-600">Optimization</p>
                                        </div>
                                        <div className="text-center p-4 bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl border-2 border-pink-300">
                                            <Sparkles className="w-8 h-8 text-pink-600 mx-auto mb-2" />
                                            <p className="text-xl font-bold text-pink-700">Digital</p>
                            ...
                            <div className="bg-gradient-to-br from-green-100 via-teal-100 to-blue-100 rounded-2xl border-2 border-green-300 shadow-xl p-8">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="p-3 bg-gradient-to-r from-green-500 to-teal-500 rounded-xl">
                                        <User className="w-6 h-6 text-white" />
                                    </div>
                                    <h2 className="text-3xl font-bold text-black">Lead Developer</h2>
                                </div>
                                ...
                                <div className="bg-white/80 backdrop-blur-lg rounded-xl p-8 space-y-6">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Anup Pradhan</h3>
                                        <p className="text-lg text-green-600 font-semibold mb-1">Full-Stack MERN Developer</p>
                                        <div className="inline-block px-4 py-2 bg-green-100 border-2 border-green-500 rounded-full mb-4">
                                            <p className="text-sm font-bold text-green-700">💻 Solo Developer - Built Entire Product</p>
                                        </div>
                                        <p className="text-gray-700 leading-relaxed max-w-2xl mx-auto">
                                    ...
                                    <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-xl p-6 border-2 border-green-200">
                                        <h4 className="text-lg font-bold text-gray-800 mb-3 text-center">🛠️ Technologies Used</h4>
                                        <div className="flex flex-wrap justify-center gap-2">
                                            {[
                                                ...
                                                <span key={tech} className="px-4 py-2 bg-white rounded-full text-sm font-bold text-gray-700 shadow-sm border border-green-200">
                                                    {tech}
                                                </span>
                                            ))}
                                        </div>
                                    ...
                                    {/* Developer Links */}
                                    <div className="space-y-3">
                                        <h4 className="text-lg font-bold text-gray-800 text-center mb-4">📫 Connect with Developer</h4>

                                        <a
                                            href="https://github.com/M0rs-Ruki/WhatsApp-Campaigner"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center gap-3 p-4 bg-gray-800 text-white rounded-xl hover:bg-gray-900 transition-all transform hover:scale-105 shadow-lg"
                                        >
                                            <Github className="w-6 h-6" />
                                            <div className="flex-1">
                                                <p className="font-bold">GitHub Repository</p>
                                                <p className="text-sm text-gray-300">View complete source code</p>
                                            </div>
                                        </a>
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm text-blue-100">Let's connect professionally</p>
                                            </div>
                                        </a>
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm text-purple-100">Check out other projects</p>
                                            </div>
                                        </a>

                                        <a
                                            href="mailto:anuppradhan929@gmail.com"
                                            className="flex items-center gap-3 p-4 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-all transform hover:scale-105 shadow-lg"
                                        >
                                            <Mail className="w-6 h-6" />
                                            <div className="flex-1">
                                                <p className="font-bold">Email Developer</p>
                                                <p className="text-sm text-green-100">anuppradhan929@gmail.com</p>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6">
                                        <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border-2 border-green-300">
                                            ...
                                            <p className="text-xl font-bold text-green-700">MongoDB</p>
                                            <p className="text-xs text-gray-600">Database</p>
                                        </div>
                                        <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border-2 border-blue-300">
                                            <Shield className="w-8 h-8 text-blue-600 mx-auto mb-2" />
                                            <p className="text-xl font-bold text-blue-700">JWT</p>
                                            <p className="text-xs text-gray-600">Security</p>
                                        </div>
                                        <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border-2 border-purple-300">
                                            <Sparkles className="w-8 h-8 text-purple-600 mx-auto mb-2" />
                                            <p className="text-xl font-bold text-purple-700">React</p>
                                            <p className="text-xs text-gray-600">Frontend</p>
                                        </div>
                                        <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl border-2 border-orange-300">
                                            <Rocket className="w-8 h-8 text-orange-600 mx-auto mb-2" />
                                            <p className="text-xl font-bold text-orange-700">Node.js</p>
                                ...
                                {/* Collaboration Note */}
                                <div className="mt-6 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-6 border-2 border-yellow-300">
                            ...
                            {/* Support Section */}
                            <div className="text-center bg-white/60 backdrop-blur-lg rounded-xl p-6 border border-white/80 shadow-lg">
